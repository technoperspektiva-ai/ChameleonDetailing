...
export const serviceCatalog:ServiceCatalogItem[]=[
  {
    id:1,slug:'exterior-detailing',basePrice:150,currency:'PLN',durationMin:90,category:'EXTERIOR',
    translations:{
  ...
  {
    id:2,slug:'interior-detailing',basePrice:120,currency:'PLN',durationMin:120,category:'INTERIOR',
    translations:{
  ...
  {
    id:3,slug:'full-detailing',basePrice:250,currency:'PLN',durationMin:180,category:'FULL',
    translations:{
  ...
  {
    id:4,slug:'ceramic-coating',basePrice:800,currency:'PLN',durationMin:360,category:'PROTECTION',
    translations:{
